# ARS Codex Pipeline Architecture (tracks ARS v3.10.0)

Full pipeline view across stages × workflows × artifacts × gates for the
Codex package. The research logic tracks upstream ARS v3.10.0, but runtime
...
```mermaid
graph TD
    Pipeline[academic-pipeline<br/>orchestrator<br/>v3.10.0<br/>5 agent prompts]
